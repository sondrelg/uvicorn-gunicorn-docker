...
from ..utils import CONTAINER_NAME, get_config, get_logs, get_response_text1, remove_previous_container
...
def test_defaults() -> None:
    ...
    container = client.containers.run(image, name=CONTAINER_NAME, ports={'80': '8000'}, detach=True)
