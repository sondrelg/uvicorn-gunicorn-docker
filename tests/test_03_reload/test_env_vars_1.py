...
from ..utils import CONTAINER_NAME, get_logs, get_response_text1, remove_previous_container
...
def test_env_vars_1() -> None:
    ...
    container.exec_run("sed -i 's|Uvicorn with Gunicorn|Uvicorn with autoreload|' /app/main.py")
